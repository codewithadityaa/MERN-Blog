  ...
  return (
    <div className="sidebar">
      <div className="sidebarItem">
        ...
        <p>
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eligendi vel sit quasi voluptatum maxime officiis, laudantium dolorum tempora officia doloribus
        </p>
      </div>
      <div className="sidebarItem">
